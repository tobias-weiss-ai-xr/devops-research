...
| AI Security | taxonomy | 155 |
| reproducibility | curated | 151 |
...
| interview | curated | 18 |
| Software-Defined Storage | taxonomy | 15 |
| K8s Security | taxonomy | 13 |
| Service Mesh | taxonomy | 12 |
| open access | curated | 11 |
| Helm | taxonomy | 9 |
| peer review | curated | 8 |
| mixed methods | curated | 7 |
...
- framework — 65 shared paper(s)
- dataset — 28 shared paper(s)
- IaC — 23 shared paper(s)
- Storage — 17 shared paper(s)
- benchmark — 16 shared paper(s)
- CI/CD — 15 shared paper(s)
- Security — 13 shared paper(s)
- Containers — 13 shared paper(s)

### case study

- framework — 56 shared paper(s)
- CI/CD — 29 shared paper(s)
- Security — 25 shared paper(s)
- IaC — 24 shared paper(s)
- qualitative — 14 shared paper(s)
...
- framework — 64 shared paper(s)
- qualitative — 32 shared paper(s)
- Security — 17 shared paper(s)
- Storage — 15 shared paper(s)
- CI/CD — 14 shared paper(s)
- Policy & Code — 14 shared paper(s)
...
- reproducibility — 8 shared paper(s)
- CI/CD — 7 shared paper(s)
- benchmark — 7 shared paper(s)
- IaC — 7 shared paper(s)
